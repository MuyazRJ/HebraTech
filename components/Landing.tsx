...
const Landing = ({ doneLoading }: { doneLoading: boolean}) => {
    ...
    return ( 
        <>
            <motion.div key="landing" className="w-full h-full absolute bg-main-black origin-top" initial={{scaleY:0}} animate={{scaleY:1}} transition={{duration:1, ease:[0.99, 0, 0.17, 1], delay: 0.3}}>
