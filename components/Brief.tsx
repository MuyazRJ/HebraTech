...
const Brief = () => {
    return ( 
        <div className="h-[100vh] bg-main-black pt-[0.75rem]">
            <div className="flex max-w-[85%] mx-auto items-center justify-center flex-col">
                <TextReveal>
                <h2 className="text-white text-2xl font-bold text-center mb-8 before:absolute relative  before:border-b-[1px] before:border-[#A3A3A3] before:w-[110%] before:right-[-5%] before:top-10 before:bottom-0">HEBRA TECHNOLOGIES</h2></TextReveal>
                ...
                <div className="justify-self-start self-start"><CustomButton text="Meet Our Founders" styles="mt-10" boxShadow="0 3em 12.5em 0 #FFB800"/></div>
            </div>
        </div>
     );
}
